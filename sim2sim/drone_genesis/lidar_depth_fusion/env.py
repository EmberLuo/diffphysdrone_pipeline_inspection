...
class NavEnv:
    def __init__(self, cfg: dict, env_name: str | None = None, show_viewer: bool = True, device: str = "cuda"):
        ...
        self.depth_width = int(depth_cfg.get("width", 64))
        self.depth_height = int(depth_cfg.get("height", 48))
        ...
        for i in range(self.num_agents):
            ...
            pattern = gs.options.sensors.raycaster.DepthCameraPattern(
                res=(self.depth_width, self.depth_height),
                fov_horizontal=float(depth_cfg.get("fov_horizontal", 55.84)),
            )
